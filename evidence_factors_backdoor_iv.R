...
p_values_null_bdoor_correct_i4_violated <- foreach(i = 1:N, .combine = c) %dopar% {
...
p_values_alternative_bdoor_correct <- foreach(i = 1:N, .combine = c) %dopar% {
...
p_values_alternative_bdoor_correct_i4_violated <- foreach(i = 1:N, .combine = c) %dopar% {
