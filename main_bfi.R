...
library(mgcv)
prefix <- "/home/junhuiyang/Documents/simulations.v3.hpc/"
prefix_output <- "/home/junhuiyang/Documents/Outputs/"
...
for (n in sample_size) {
  ...
  source(paste0(prefix,"evidence_factors_backdoor_frontdoor_iv.R"))
  assign(paste0("df_backdoor_frontdoor_iv_", n), 
         cbind(backdoor = backdoor_values, frontdoor = frontdoor_values, iv = iv_values,
               ...
               b1 = b1, b2 = b2, f1 = f1, f2 = f2, f3 = f3, 
               i1 = i1, i2 = i2, i3 = i3, i4 = i4, 
               hypothesis = hypothesis, beta = beta, sample_size = rep(n, length(beta)), 
               size = size_values, power = power_values))
  write.csv(get(paste0("df_backdoor_frontdoor_iv_", n)), 
            file = paste0(prefix_output, "df_backdoor_frontdoor_iv_", n, ".csv"))
